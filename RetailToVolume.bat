...
echo pick which you want to turn:

echo.

echo --------------------------------------------------------------------------------

echo 1. Retail Office Pro Plus 2016 To VOL

echo.

echo 2. Retail Office Visio Pro 2016 To VOL

echo.

echo 3. Retail Office Project Pro 2016 To VOL

echo.

echo 4. Retail Office Pro Plus 2013 To VOL

echo.

echo 5. Retail Office Visio Pro 2013 To VOL

echo.

echo 6. Retail Office Project Pro 2013 To VOL

echo.

echo 7. Retail Office Pro Plus 2010 To VOL

echo.

echo 8. Retail Office Visio Pro 2010 To VOL

echo.

echo 9. Retail Office Project Pro 2010 To VOL

echo.

echo. --------------------------------------------------------------------------------

set /p tsk="type the number (1~9) and enter to confirm: "
...
echo Instaling KMS Licence...

for /f %%x in ('dir /b ..\root\Licenses16\proplusvl_kms*.xrm-ms') do cscript ospp.vbs /inslic:"..\root\Licenses16\%%x" >nul

echo Instaling MAK Licence...
...
set /p y=input the key and enter to confirm:
